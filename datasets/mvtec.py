...
CLASS_NAMES = ['mild_disease', 'mix_disease', 'moderate_disease', 'severe_disease']

class MVTecDataset(Dataset):
    def __init__(self, dataset_path='/data/LiuYuyao/Dataset/railway_anomaly_detection_standard5/', class_name='bottle', is_train=True,
